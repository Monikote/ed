...
public interface ChessBoard {
     ...
     * @param location ruta del archivo a guardar.
     * @return true si lo guarda, false en caso contrario.
     */
    boolean saveToFile(File location);

    /**
     * Esta función abre la partida que hay en un archivo
     * @param location ruta del archivo a cargar.
     * @return true si carga, false en caso contrario.
     */
